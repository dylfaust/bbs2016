	...
	<body class="main secondary web">
		...
		<div class="marketing-container">
			...
			<div id="eventChecklist">
				...
				<div class = "eventChecklist_small">
						<div class = "checklist_small" id = "eventChecklist_small-01">
							<img class = "transpImage" src="/img/checklist_small-01.svg">
						</div>

						<div class = "checklist_small" id = "eventChecklist_small-02">
							<img class = "transpImage" src="/img/checklist_small-02.svg">
						</div>

						<div class = "checklist_small" id = "eventChecklist_small-03">
							<img class = "transpImage" src="/img/checklist_small-03.svg">
						</div>

						<div class = "checklist_small" id = "eventChecklist_small-04">
							<img class = "transpImage" src="/img/checklist_small-04.svg">
						</div>

						<div class = "checklist_small" id = "eventChecklist_small-05">
							<img class = "transpImage" src="/img/checklist_small-05.svg">
						</div>

						<div class = "checklist_small" id = "eventChecklist_small-06">
							<img class = "transpImage" src="/img/checklist_small-06.svg">
						</div>
				...
				<div class = "col-md-6">
					...
					<div class = "eventChecklist_step">
						...
						<p class = "eventChecklist_bodyText1">Design & print: posters, fliers, banners, signage, programs, & tickets</p>
					</div>

					<div class = "eventChecklist_step">
			   			<img class = "transpImage" src="/img/eventMarket.svg">
						<p class = "eventChecklist_bodyText2">Plan & buy media: Strategize, plan, negotiate, and broker all media</p>
					</div>

					<div class = "eventChecklist_step">
			   			<img class = "transpImage" src="/img/eventMarket.svg">
						<p class = "eventChecklist_bodyText3">Create splash page: Set-up custom web page for event</p>
					</div>
				...
				<div class = "col-md-6">
						...
						<div class = "eventChecklist_step">
				   			<img class = "transpImage" src="/img/eventMarket.svg">
							<p class = "eventChecklist_bodyText4">Create advertisements: TV, radio, and Internet production</p>
						</div>

						<div class = "eventChecklist_step">
				   			<img class = "transpImage" src="/img/eventMarket.svg">
							<p class = "eventChecklist_bodyText5">Coordinate Media: Leverage earned media where plausible</p>
						</div>

						<div class = "eventChecklist_step">
				   			<img class = "transpImage" src="/img/eventMarket.svg">
							<p class = "eventChecklist_bodyText6">Deploy Social Campaign: Strategize, plan, & implement social media marketing</p>
						</div>
		...
		<div class="ribbon orange">
			<div class="container">
				<h1>
					Ready to bring your brand to the world?
				</h1>
