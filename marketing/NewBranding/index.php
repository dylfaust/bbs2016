...
<html lang="en">
	...
	<body class="main secondary web">
		...
		<h1 style= "margin-bottom: -5px;">Unlocking Branding Success</h1>
...
$(document).ready(function(){
    ...
    area = 35000;
    width = $('.marketing-container').width();
    if (width <= 499) {
    $('.key').css("padding-bottom", Math.ceil(area/width) + "px");
}
