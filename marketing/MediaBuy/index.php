...
<div class="container advertising-directions">
	...
	<div class = "mediaProcess">
		...
		<h2 id = "mediaProcess_title">MEDIA BUYING PROCESS</h2>
		...
		<div id = "mediaProcess-01">
			...
			<div id = "mediaProcess_Body-01">
				<p class = "mediaProcess_BodyText">We take in your product and your target demographic and lay out a plan that matches your budget and ability to handle the new incoming sales.</p>
			</div>
		</div>
		...
		<div id = "mediaProcess-02">
			...
			<div id = "mediaProcess_Body-02">
				<p class = "mediaProcess_BodyText">We go to bat for you garnering the best buy for the buck we can get. You get the benefits of our strong buying power and relationships with media outlets.</p>
			</div>
		</div>	
		...
		<div id = "mediaProcess-03">
			...
			<div id = "mediaProcess_Body-03">
				<p class = "mediaProcess_BodyText">We analyze the results of your media buy and probe into what worked and what needs work moving forward. This is a team effort between you and BBS.</p>
			</div>
		</div>	
		...
		<div id = "mediaProcess-04">
			...
			<div id = "mediaProcess_Body-04">
				<p class = "mediaProcess_BodyText">Taking what was learned from probing, we start tweaking our buying strategy. This affects the overall plan, so we start the process over ensuring ongoing effectiveness.</p>
			</div>
		</div>	
