...
<html lang="en">
	...
	<body class="main secondary web">
		...
		<div class = "container text-align-center text-styles">
		<h1 style="padding-top:50px;">Five Steps to Successful Internet Advertising</h1>
		</div>
		</div>
	...
	<div class = "advert_small">
			<img class = "transpImage" src="/img/internetAdvert_small.svg">
		</div>
		</div>
	...
	<div id="advert_instruct">
		...
		<div class = "advert_step" id = "advert_step-01">
   			...
   			<div class = "advert_HeaderM">
				<h2 class = "advert_head">LOCATE</h2>
			</div>
			<div class = "advert_BodyM">
	...
	<div class="ribbon orange">
			<div class="container">
				<h1>
					Ready to take your advertising to the web?
				</h1>
